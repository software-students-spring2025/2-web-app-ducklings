...
if menu_collection.count_documents({}) == 0:
    menu_collection.insert_many([
        ...
        {'item_id': 'strawberry_shortcake', 'name': 'Strawberry Shortcake',  'description': "Crumbly cake with whipped frosting and fresh strawberries", 'price': 20, 'category': 'Cakes', 'allergy_info': 'gluten, dairy, eggs', 'calories': 300},
